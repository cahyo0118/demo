...
@RequestMapping("api")
@AllArgsConstructor
public class AccountUnbindingController {
    private final MerchantRepository merchantRepository;
    private final MerchantService merchantService;

    @RequestMapping(
            method = RequestMethod.POST,
            path = "v1/registration-account-unbinding"
    )
    private ResponseEntity<HashMap<String, Object>> accountUnbinding(@RequestBody HashMap<String, Object> body) {
